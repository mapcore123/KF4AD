...
class AEKF3:
    ...
    def update(self, z: np.ndarray, r: np.ndarray) -> None:
        ...
        z_nor_hat = g_nor(q) + white_noise(self.Rnor)
        z_nor = 1 # constant    
        # Innovation vector y
        y_nor = z_nor - attitude_matrix(q) @ r # dims (3,1)
